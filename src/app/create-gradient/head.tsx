export default function Head() {
  return (
    <>
      ...
      <meta
        name="keywords"
        content="gradient creation, gradient maker, gradient design, gradient editor, gradient tool, color gradient, smooth gradient, gradient palette, gradient generator, gradient preview, gradient CSS, gradient background, gradient transition"
      ></meta>
